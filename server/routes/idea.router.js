...
const {rejectUnauthenticated, rejectIfNotArist} = require('../modules/authentication-middleware');
...
// //post for idea form
// router.post('/', rejectIfNotArist, (req, res) => {
//     const query = `
//    INSERT INTO "ideas"
//    ("artist_id","idea")
//    VALUES ($1, $2);
//     `;
//     pool.query(query, [req.user.id, req.body.idea])
//     .then(result => {
